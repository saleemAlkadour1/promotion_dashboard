...
class ShowCategory extends StatelessWidget {
  const ShowCategory({super.key, required this.categoryModel});
  final CategoryModel categoryModel;
  @override
  Widget build(BuildContext context) {
    ShowCategoryControllerImp initialController =
        Get.put(ShowCategoryControllerImp());
    initialController.initialCategory(categoryModel);
    return GetBuilder<ShowCategoryControllerImp>(builder: (controller) {
      return Scaffold(
